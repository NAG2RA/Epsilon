...
{
public:
	float rotation, rotationalVelocity, drag, InverseMass;
	float density, mass, restitution, area, radius, width, height;
	...
	void updateMovement(float& dt, Vector2f gravity);
